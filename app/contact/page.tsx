...
const socialLinks = [
  {
    ...
    icon: (
      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        <path d="M11.5 7.5c-.7-.4-1.5-.3-2.1.2-.6.5-.9 1.3-.7 2.1l1.4 6.5c.2.9 1.1 1.5 2 1.3.9-.2 1.5-1.1 1.3-2l-1.4-6.5c-.2-.7-.7-1.3-1.5-1.6zM7 6.5c-.8 0-1.5.4-1.9 1-.4.6-.4 1.4 0 2l4.2 7.5c.4.7 1.3 1 2.1.6.7-.4 1-1.3.6-2.1L7.8 8c-.4-.6-.8-1.1-1.5-1.3-.1-.1-.2-.2-.3-.2zM17.5 9c-.8-.3-1.6 0-2.1.6l-3.5 5c-.4.6-.3 1.4.2 1.9.5.5 1.3.6 1.9.2l4.5-3.5c.6-.5.8-1.3.5-2-.3-.7-1-1.1-1.5-1.2z" />
      </svg>
    ),
  },
  {

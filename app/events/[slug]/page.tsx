...
function getPresentationUrl(eventIndex: number, presentationPath: string): string | null {
                ...
                {event.talks && event.talks.length > 0 && (
                  <div className="mt-8 space-y-6">
                    ...
                    {event.talks.map((talk, talkIndex) => {
                      // Null when B2 is unconfigured, which is how dev and fork builds run.
                      const presentationUrl = talk.presentation
                        ? getPresentationUrl(event.index, talk.presentation)
                        : null
